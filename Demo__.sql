...
USE WAREHOUSE TESTIN_WAREHOUSE
...
SELECT * FROM "DEMODATABASE" ."PUBLIC"."AGENTS"; -- Access the data from any data base with this command.  --PUBLIC IS SCHEMA  ---AGENT IS TABLE NAME. --DEMODATABASE IS DATABASE NAME. --


select DISTINCT ORD_AMOUNT from ORDERS;


select * from "DEMODATABASE"."PUBLIC"."AGENTS";
